...
import { Sun, Users, CheckSquare, Sparkles, Plus, User, FileDown, PanelLeft, Inbox, StickyNote, Bot, Terminal, CalendarDays, Mic, Loader2, CircleAlert, Bell, AudioLines } from 'lucide-react'
