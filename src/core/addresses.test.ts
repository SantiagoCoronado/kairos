...
describe('isMailToSelf', () => {
  ...
  it('accepts any of your addresses — a send-as alias mailing itself', () => {
    expect(isMailToSelf({ to: 'me@alias.com' }, ['me@x.com', 'me@alias.com'])).toBe(true)
    expect(isMailToSelf({ to: 'me@alias.com, me@x.com' }, ['me@x.com', 'me@alias.com'])).toBe(true)
    expect(isMailToSelf({ to: 'me@alias.com' }, ['me@x.com'])).toBe(false)
    expect(isMailToSelf({ to: 'me@x.com' }, [])).toBe(false)
  })
